...
def lista_do_equipamento():
    while True:
        resposta = menu(['OLT_HUAWEI_ALPHAVILLE_02' , 'OLT_HUAWEI_CCP_00' , 'OLT_HUAWEI_CCP_01', 'OLT_HUAWEI_CCP_02', 'OLT_HUAWEI_CENTURY_1', 'OLT_HUAWEI_DOWNTOWN', 'OLT_HUAWEI_DOWNTOWN_00', 'OLT_HUAWEI_ELDORADO_01', 'OLT_HUAWEI_HELBOR_01', 'OLT_HUAWEI_HELBOR_02', 'OLT_HUAWEI_HELBOR_TTE_00', 'OLT_HUAWEI_JACAREI', 'OLT_HUAWEI_MANSAO', 'OLT_HW_PQTEC_01', 'OLT_HW_TREMEMBE', 'SAIR'])
        if resposta == 1:
            print(linha())
            print(menu[resposta])
